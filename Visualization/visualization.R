...
HousePricesclean %>% 
  ...
  geom_bar(position = "stack",stat = "identity", fill = "darkgrey") +
...
schoolData %>%
  ...
  geom_boxplot(color = "green", fill = "steelblue") +  
...
color= c("OXFORDSHIRE" = "grey", "YORKSHIRE" = "red")
